...
const translations = {
  ar: {
    ...
    home: {
      ...
      track_btn: 'تتبع طلبي',
      stats_years: 'سنوات من الاستدامة والأثر',
      stats_families: 'عائلة شملتها رعاية المؤسسة',
      stats_requests: 'إستجابة إنسانية متكاملة',
      stats_cities:'محافظة سورية ضمن نطاق عملنا',
    ...
    footer: {
      ...
      email: 'info@ghozlanfoundation.com',
  ...
  en: {
    ...
    home: {
      ...
      stats_years: 'Years of Sustainable Impact',
      stats_families: 'Families Under Our Care',
      stats_requests: 'Integrated Humanitarian Responses',
      stats_cities: 'Syrian Governorates Within Our Reach',
